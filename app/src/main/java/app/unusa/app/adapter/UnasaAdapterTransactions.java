...
public class UnasaAdapterTransactions extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public UnasaAdapterTransactions(Context context, List<People> items) {
        this.items = items;
        ctx = context;
    }
